...
const commentsData = [
    {
        name:"Akib Hobale",
        text:"Lorn ipnm dolor sit amet, constructor adip",
        replies:[],
    },
    {
        name:"Akib Hobale",
